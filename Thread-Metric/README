...
tm_porting_layer.c                          Generic shell for RTOS porting
                                              layer
...
As for the porting layer defined in tm_porting_layer.c, this file contain 
...
are achieved on each RTOS performing the test:
    ...
    2. The porting layer services are implemented inside of 
       tm_porting_layer.c and NOT as macros.
...
The ThreadX API is copyrighted by Express Logic, Inc.
