...
void  tm_initialize(void (*test_initialization_function)(void))
{
    ...
    /* Never returns... the test initialization function is actually called
       from the ThreadX tx_application_define function.  */
}
...
/* Define the ThreadX initialization function.  */

void  tx_application_define(void *not_used)
{
